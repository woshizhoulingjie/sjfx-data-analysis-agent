...
def export_node(root, selected, summary, output_dir, max_bytes, analysis=None, documents=None, task_topic=None,
    ...
    with _atomic_zip(temporary_archive_path, archive_path) as archive:
        ...
        archive.writestr("结论-证据链.json", json.dumps({
            ...
            "file_conclusions": (summary or {}).get("file_conclusions", []),
            "file_arguments": (summary or {}).get("file_arguments", []),
            "file_review_items": (summary or {}).get("file_review_items", []),
            "file_limitations": (summary or {}).get("file_limitations", []),
            "evidence_quality": (summary or {}).get("evidence_quality", {}),
            "claim_contract": (summary or {}).get("claim_contract", "file-claims/1.0"),
